...
function LinkButton({
  ...
  const styles: Record<ButtonType, string> = {
    ...
    tertiary: classnames(
      'flex items-center rounded-md text-gray-800 underline transition-colors font-normal decoration-1 underline-offset-2 hover:no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-700',
      'gap-1 text-base',
      'sm:gap-1.5 sm:text-base',
      'md:gap-2 md:text-base',
      'lg:gap-2 lg:text-lg lg:font-light',
      'xl:gap-2 xl:text-xl'
    ),
  };
