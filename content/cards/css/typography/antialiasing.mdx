---
question: |
  What are the different strategies of font antialiasing on web?
  What OS and browser combinations support them?
...
Subpixel antialiasing works only on macOS browsers, excluding Firefox. Windows uses `antialiased` value by default, and it is not subject to changes.
