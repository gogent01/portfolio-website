...
const GithubIcon = React.forwardRef(function GithubIcon(
  ...
  return (
    <a
      ref={ref}
      href="https://github.com/gogent01"
      target="_blank"
      {...props}
...
const LinkedInIcon = React.forwardRef(function LinkedInIcon(
  props: ComponentProps<'a'>,
  ref: React.Ref<HTMLAnchorElement>
) {
  return (
    <a
      ref={ref}
      href="https://www.linkedin.com/in/gamishurovsky/"
      target="_blank"
      {...props}
      className={classNames('', props.className)}
    >
...
const MailIcon = React.forwardRef(function MailIcon(
  props: ComponentProps<'a'>,
  ref: React.Ref<HTMLAnchorElement>
) {
  return (
    <a
      ref={ref}
      href="mailto:gamishurovskiy@gmail.com"
      {...props}
      className={classNames('', props.className)}
    >
      <svg
